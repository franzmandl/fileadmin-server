...
import com.franzmandl.fileadmin.resource.TaskDtoHelper
...
class TaskIT(
    ...
    private val doneStatusName = applicationCtx.task.doneStatusName
    ...
    private var expectedPriority: Int? = null
    ...
    private fun createTaskCtx(now: LocalDate, files: Iterable<Inode1<*>>): TaskCtx =
    ...
    private fun assertRepeatingTask(trigger: String, expectedDoneTrigger: String, expectedDate: LocalDate): TaskDate {
        ...
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, taskDate, "dummy")).isEqualTo("../dummy/$name")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, taskDate, doneStatusName)).isEqualTo("$expectedDoneTrigger - title.txt")
        return taskDate
    }
    ...
    private fun assertTask(trigger: String, expectedDate: LocalDate): TaskDate {
        ...
        assertThat(expectedDate).isEqualTo(taskDate.date)
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, taskDate, "dummy")).isEqualTo("../dummy/$name")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, taskDate, doneStatusName)).isEqualTo("../$doneStatusName/$name")
        return taskDate
    }
    ...
    fun testRepeatingTaskRegistry() {
        ...
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, idTaskDate, doneStatusName)).isEqualTo("${now + Period.ofWeeks(1)}R1W & id(1) - test")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, refTaskDate, doneStatusName)).isEqualTo("${now + Period.ofWeeks(2)}R2W & ref(1) - test")
    }
    ...
    fun testDoubleRepeatingTaskRegistry() {
        ...
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, idTaskDate1, doneStatusName)).isEqualTo("${now + Period.ofWeeks(1)}R1W & id(1) - test")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, refTaskDate1, doneStatusName)).isEqualTo("${now + Period.ofWeeks(2)}R2W & ref(1) - test")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, idTaskDate2, doneStatusName)).isEqualTo("${now + Period.ofWeeks(3)}R3W & id(2) - test")
        assertThat(TaskDtoHelper.getStatusPath(doneStatusName, refTaskDate2, doneStatusName)).isEqualTo("${now + Period.ofWeeks(6)}R6W & ref(2) - test")
    }
